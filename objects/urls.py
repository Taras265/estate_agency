...
urlpatterns = [
    ...
    path("sale/report/", views.ReportListView.as_view(), name="report_list"),
    path("sale/report/<str:filter>/", views.ReportListView.as_view(), name="report_list"),

    path(
        "sale/contracts/apartments/",
        views.BaseContractListView.as_view(type=RealEstateType.APARTMENT),
        name="apartment_contracts"
    ),
    path(
        "sale/contracts/commerces/",
        views.BaseContractListView.as_view(type=RealEstateType.COMMERCE),
        name="commerce_contracts"
    ),
    path(
        "sale/contracts/houses/",
