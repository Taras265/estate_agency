...
class MyFilialListView(
    ...
    def get_queryset(self):
        ...
        return (
            CustomUser.objects
            .filter(filials__in=filials, is_active=True)
            .distinct()
            .select_related()
            .prefetch_related("filials")
        )


class FilialRealtorsClientsListView(
    CustomLoginRequiredMixin, PermissionRequiredMixin, SaleListContextMixin, ListView
):
    model = Client
...
class FilialRealtorsApartmentListView(
    CustomLoginRequiredMixin, PermissionRequiredMixin, SaleListContextMixin, ListView
):
    model = Apartment
    template_name = "objects/filial_realtors_list.html"
    context_object_name = "objects"
...
class FilialRealtorsCommerceListView(
    CustomLoginRequiredMixin, PermissionRequiredMixin, SaleListContextMixin, ListView
):
    model = Commerce
    template_name = "objects/filial_realtors_list.html"
...
class FilialRealtorsHouseListView(
    CustomLoginRequiredMixin, PermissionRequiredMixin, SaleListContextMixin, ListView
):
    model = House
    template_name = "objects/filial_realtors_list.html"
...
class FilialRealtorsLandListView(
    CustomLoginRequiredMixin, PermissionRequiredMixin, SaleListContextMixin, ListView
):
    model = Land
    template_name = "objects/filial_realtors_list.html"
